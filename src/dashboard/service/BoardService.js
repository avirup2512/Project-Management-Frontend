...
let BoardService = (function () {
  ...
  BoardService.prototype.getAllBoards = async function (
    token,
    projectId,
    isActive,
    itemLimit,
  ...
  BoardService.prototype.getAllTag = async function (boardId) {
  ...
  BoardService.prototype.editBoardTag = async function (params) {
  ...
  BoardService.prototype.addBoardTag = async function (params) {
  ...
  BoardService.prototype.deleteBoardTag = async function (boardTagId, boardId) {
    const res = await fetch(
