...
let ListService = (function () {
  ...
  ListService.prototype.getAllList = async function (boardId, isArchive) {
    const res = await fetch(
      baseUrl + "list/getAllList/" + boardId + "/" + isArchive,
      {
        method: "GET",
        headers: {
  ...
  ListService.prototype.deleteList = async function (params) {
