...
export const DashboardSlice = createSlice({
    ...
    reducers: {
        ...
        setPaginateHappen: (state,action) => {
            state.paginateHappen = action.payload;
        }
    }
})
export const {setPage, setAllRoles,setProjectPaginationObject,setBoardPaginationObject,setProjectPaginationDefault,setBoardPaginationDefault,setPaginateHappen } = DashboardSlice.actions;
