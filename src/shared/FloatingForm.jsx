              ...
              <div className="parentWrapper position-relative">
                        ...
                        <div className="result">
                          {searchedList.map((item, index) => {
                            return (
                              <p
                                className={`${
                                  selectedItemMap.has(parseInt(item.id))
                                    ? "disabled"
                                    : ""
                                } ${true ? "item" : ""}`}
                                onClick={itemSelect.bind(null, item)}
                                key={index}
                              >
                              ...
                              >
                                ...
                                {!sl.creator && (
                                  <i
                                    ...
                                    className="cursor-pointer bi bi-x-circle-fill red"
                                  ></i>
                                )}
                ...
                {inputLabel == "Tags" && (
                  <>
                    <section className="addTag">
                      <Form className="d-flex align-items-center ">
                        ...
                        <Form.Group controlId="formSearch" className="me-2">
                          <Form.Control type="color" placeholder="Search" />
                        </Form.Group>
                      </Form>
                      <Button
                    ...
                    <section className="boardTag"></section>
                  </>
                )}
              </div>
            </Modal.Body>
